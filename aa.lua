...
-- Secret names list
local SECRETS = { "La Grande Combinasion", "Garama and Madundung", "Nuclearo Dinossauro", "Chicleteira Bicicleteira",
"Los Combinasionas", "Burguro And Fryuro", "Los 67", "Dragon Cannelloni", "Chillin Chilli", "Secret Lucky Block",
"Los Hotspotsitos", "La Secret Combinasion", "Esok Sekolah", "La Supreme Combinasion", "Spaghetti Tualetti",
"Chimpanzini Spiderini", "Los Mobilis", "Los Bros", "67", "Chillin Chilli", "Fragola La La La", "Tralaledon",
"La Spooky Grande", "Eviledon", "Ketchuru and Musturu", "Las Sis", "Spooky and Pumpky", "Los Chicleteiras",
"Celularcini Viciosini", "Tralaledon", "Ketupat Kepat", "Tacorita Bicicleta", "Mariachi Corazoni",
"Money Money Puggy", "Tang Tang Kelentang", "Los Tacoritas", "Tictac Sahur", "Ketupat Kepat", "La Extinct Grande",
